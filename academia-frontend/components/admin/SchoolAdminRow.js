  ...
  return (
    <div className="flex items-center justify-between py-3 px-2 text-sm">
      ...
      <div className="flex items-center gap-3 shrink-0 text-gray-400">
        <button onClick={() => setEditing(true)} className="p-1.5 rounded hover:bg-gray-200 dark:hover:bg-gray-800 hover:text-accent transition-colors" aria-label="Edit school">
