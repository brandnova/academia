...
1. Prepare the project for massive traffic by running through a list of things to do, I learned that projects with high traffic usually cache heavily. List some other things to do for this. I have redis up and running on my PC.
1. Preparation for Frontend API connection (CORS + others)
...
# Pre Prod setup
- Implement username/email and password login & a registration workflow. Should come with some form of standard email verification and password change/reset, basically minimal account management.
